...
class TrainTransforms():
    def __init__(self):
        ...
        self.transform = A.Compose([
            ...
            A.RandomCrop(32, 32),
            A.HorizontalFlip(),
            A.Cutout(num_holes=1, max_h_size=8, max_w_size=8, fill_value=[0.4914, 0.4822, 0.4471], always_apply=True, p=0.3),
            ToTensorV2()
        ])
...
class TrainTestDataloaders:
    ...
    def get_dataloader_args(self):
        ...
        dataloader_args = dict(shuffle=True, batch_size=512, num_workers=4, pin_memory=True) if is_cuda else dict(shuffle=True, Batch_size=512)
